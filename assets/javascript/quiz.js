...
$(document).ready(function () {
    ...
    var questions = [
        ...
        {   //Q.1
            ...
            anScore: [
                [-5, 5, 7, 4, 6, 0, 9, -5, 8, -5, -7, 0, 1, 0, 6, 8, -5, 4, -10, -10, 2],
                [6, 7, 0, 10, -5, 3, 6, 4, 5, 8, 3, 0, 4, 4, 6, 4, 0, -2, 6, 4, 3],
        ...
        {   //Q.2
            ...
            anScore: [
                ...
                [-4, -6, 5, 0, 4, 3, -6, 6, 7, -3, 10, 9, -4, -3, 8, -7, -4, 8, 0, 0, 2],
                [-5, 5, 7, 4, 6, 0, 9, -5, 8, -5, -7, 0, 1, 0, 6, 8, -5, 4, -10, -10, 2],
                [6, 1, 2, -5, 8, 6, -5, 4, -6, 3, 0, 2, 4, 2, -6, -10, 8, 0, 9, 8, 6],
            ]
        },
        ...
        {   //Q.6
            ...
            anScore: [
                ...
                [8, 0, 6, 9, -2, 4, 8, 2, -6, 1, -2, 4, -8, 8, 6, -10, 6, 7, 9, 10],
        ...
        {   //Q.7
            ...
            anScore: [
                [-5, 8, 2, -2, 1, 9, 9, -5, 8, -5, -7, 0, 1, 0, 9, -2, -5, 5, -10, -10, 8]
        ...
        {   //Q.10
            ...
            anScore: [
                [2, 5, 7, 4, 6, 0, 9, -2, -6, -5, 2, 10, -6, 2, 1, -9, 6, 2, 7, 6, -2],
                [-5, 8, 2, -2, 1, 9, 9, -5, 8, -5, -7, 0, 1, 0, 8, -2, -5, 5, -10, -10, 8],
                [-5, 5, 7, 4, 6, 0, 9, -5, 8, -5, -7, 0, 1, 0, 9, 8, -5, 4, -10, -10, 2],
                [-6, -9, -8, -7, 6, -4, 3, -2, 6, -10, 3, 8, 2, -4, 9, -8, 1, -2, 8, 2],
            ]
        },
        ...
        {   //Q.12
            ...
            anScore: [
                ...
                [6, 10, 8, 7, 2, 6, 7, 10, 1, -6, 10, 9, -7, 2, 4, 9, 1, -6, 7, -3, -6],
                [-6, -9, -8, -7, 6, -4, 3, -2, 6, -10, 3, 8, 2, -4, 9, -8, 1, -2, 8, 2],
                [-5, 5, 7, 4, 6, 0, 9, -5, 8, -5, -7, 0, 1, 0, 8, 8, -5, 4, -10, -10, 2],
            ]
        },
        ...
        {   //Q.15
            ...
            anScore: [
                [-5, 5, 7, 4, 6, 0, 9, -5, 8, -5, -7, 0, 1, 0, 10, 8, -5, 4, -10, -10, 2],
                [2, 5, 7, 4, 6, 0, 9, -2, -6, -5, 2, 10, -6, 2, 1, -9, 6, 2, 7, 6, -2],
                [-5, 8, 2, -2, 1, 9, 9, -5, 8, -5, -7, 0, 1, 0, 6, -2, -5, 5, -10, -10, 8]
                [8, 0, 6, 9, -2, 4, 8, 2, -6, 9, 1, -2, 4, -8, 9, 6, -10, 6, 4, 9, 10],
            ]
        },
        ...
        {   //Q.16
            ...
            anScore: [
                ...
                [2, 5, 7, 4, 6, 0, 9, -2, -6, -5, 2, 10, -6, 2, 1, -9, 6, 2, 7, 6, -2],
                [-2, -5, -6, 4, -8, 8, 10, 2, -7, 6, 5, -2, 10, -5, 2, 8, 9, -1, -6, -8, 1],
                [-5, 5, 7, 4, 6, 0, 9, -5, 8, -5, -7, 0, 1, 0, 7, 8, -5, 4, -10, -10, 2],
            ]
        },
        ...
        {   //Q.17
            ...
            anScore: [
                ...
                [-5, -6, -10, -2, -6, 5, -8, 9, 2, -4, -10, 3, 9, 9, 10, -6, 7, -5, -9, 2],
                [-5, 5, 7, 4, 6, 0, 9, -5, 8, -5, -7, 0, 1, 0, 10, 8, -5, 4, -10, -10, 2],
            ]
        },
